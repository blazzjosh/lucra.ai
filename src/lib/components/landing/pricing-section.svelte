	...
	let productPrices = [
		{
			id: 'price_1',
			name: 'Basic',
			description: 'A basic plan for individual and small business users',
			features: [
	...
	<div class="mx-auto flex max-w-screen-xl flex-col gap-8 px-4 py-14 md:px-8">
		<div class="mx-auto max-w-5xl text-center">
			...
			<p class="mt-6 text-xl leading-8 text-black/80 dark:text-white">
				...
				{' '}
				that&apos;s packed with the best features for tracking your finances.
			</p>
		</div>
		...
		<div class="mx-auto flex gap-4">
			{#each productPrices as price, id}
				...
				>
					...
					>
						<span class="absolute right-0 -mt-12 h-32 w-8 translate-x-12 rotate-12 transform-gpu bg-white opacity-10 transition-all duration-1000 ease-out group-hover:-translate-x-96 dark:bg-black"
